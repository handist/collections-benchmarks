 ...
 *
 */
public class UFS3 implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        for (int round = 0; round < ROUNDS; round++) {
            ...
            GlobalLoadBalancer.underGLB(() -> {
                ...
                final int localTreeSeed = rnd.nextInt();
                final DistFuture<DistBag<Long>> future = host0localTrees.GLB
                        .toBag(t -> t.growTree(localTreeSeed, HOST0_TREE_DEPTH));
    ...
    public static void printUsage() {
        System.err.println("Udage: mpirun -np <N> java -cp <classpath> " + Launcher.class.getCanonicalName() + " "
                + UFS3.class.getCanonicalName() + " ARGUMENTS");
