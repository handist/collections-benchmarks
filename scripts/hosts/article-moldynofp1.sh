...
export BENCHMARKS="moldyn-hybrid.sh moldyn-hybrid-split16.sh moldyn-seqmt.sh moldyn-seqmt-split16.sh moldyn-seq.sh moldyn-mpi.sh moldyn-simpleseq.sh moldyn-dist.sh"
