...
export BENCHMARKS="flatkmeans-huge.sh trianglekmeans-huge.sh fcm-flat-huge.sh" # flatkmeans-huge-log.sh trianglekmeans-huge-log.sh"
...
#export CONFIGS="nolifeline-nolongboxing.sh hypercube-nolongboxing.sh lifeline-noanswerafterintraLB.sh
export CONFIGS="logger-lifeline.sh logger-nolifeline.sh"
#hypercube-bugfix.sh" #" # lifeline-debug.sh
