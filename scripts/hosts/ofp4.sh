...
export BENCHMARKS="kmeans-grain.sh trianglekmeans-small.sh flatkmeans-small.sh trianglekmeans-large.sh flatkmeans-large.sh trianglekmeans-larger.sh flatkmeans-larger.sh flatkmeans-huge.sh trianglekmeans-huge.sh"
#"trianglekmeans2-small.sh"

# List of library configruations that we want to test
export CONFIGS="nolifeline-nolongboxing.sh hypercube-nolongboxing.sh" # lifeline-debug.sh lifeline-noanswerafterintraLB.sh"
