...
export BENCHMARKS="kmeans-grain.sh trianglekmeans-small.sh flatkmeans-small.sh trianglekmeans-larger.sh flatkmeans-larger.sh flatkmeans-huge.sh trianglekmeans-huge.sh"
