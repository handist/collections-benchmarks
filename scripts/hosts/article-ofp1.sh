...
#export BENCHMARKS=""
export BENCHMARKS="article-ofp-renaissancekmeans.sh article-ofp-nompikmeans.sh article-ofp-teamedkmeans.sh article-ofp-teamedkmeans2.sh article-ofp-nompikmeans2.sh article-ofp-renaissancekmeans2.sh"
