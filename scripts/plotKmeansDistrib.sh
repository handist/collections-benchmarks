...
PROBLEM="hugekmeanstriangle hugekmeansflat"
...
do
    ...
    do
        ...
        do
            ...
            OUTFILE="${OUTDIR}/ofp${hst}_${SUFFIX}"
            ...
            cat ${file} | sed '/^Starting\b/d' | sed '/Init;/d' | sed -s 's/$/;/' > data.csv
            gnuplot -c gnuplot/kmeans-distribution.plt ${hst} data.csv > $OUTFILE
